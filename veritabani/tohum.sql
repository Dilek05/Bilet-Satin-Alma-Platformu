...
INSERT INTO user (id, full_name, email, password_hash, role, company_id, balance_kurus) VALUES
  ...
  ('usr-7', 'Sistem Yonetici', 'admin@example.com', '$2y$10$9jJz0Q6Dhxqm6BN0fNxmG.jIZh.SF6oY4u/Wzf/QpSOU8V03KrTce', 'ADMIN', NULL, 0);
...
INSERT INTO trips (id, company_id, origin_city, destination_city, departure_time, arrival_time, price_kurus, capacity) VALUES
  ('trp-1', 'cmp-1', 'Karabük', 'Ankara', datetime('now','+1 day','10:00'), datetime('now','+1 day','13:00'), 15000, 40),
  ('trp-2', 'cmp-2', 'Karabük', 'İstanbul', datetime('now','+2 day','09:00'), datetime('now','+2 day','16:00'), 45000, 40),
  ('trp-3', 'cmp-3', 'Ankara', 'İzmir', datetime('now','+3 day','08:00'), datetime('now','+3 day','15:30'), 55000, 45),
  ('trp-4', 'cmp-3', 'İzmir', 'Ankara', datetime('now','+4 day','12:00'), datetime('now','+4 day','19:00'), 55000, 45),
  ('trp-5', 'cmp-4', 'İstanbul', 'Antalya', datetime('now','+1 day','07:30'), datetime('now','+1 day','14:00'), 62000, 42),
  ('trp-6', 'cmp-4', 'Antalya', 'İstanbul', datetime('now','+5 day','15:30'), datetime('now','+5 day','22:30'), 62000, 42),
